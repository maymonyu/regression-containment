...
with open('averages - number of robots and circumference.csv', newline='') as csvfile:
    ...
    for row in reader:
        if row["Row Labels"] == "10" or row["Row Labels"] == "20" or row["Row Labels"] == "30" or row["Row Labels"] == "40" or row["Row Labels"] == "50":
            ...
            area.append(float(row["Row Labels"]))
